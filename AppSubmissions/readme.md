# Astralixi App Submissions
Astralixi may look kind of hard to contribute to directly, but you can still easily make Applications using the open source API available. To make an application use the designated API along with the help from the API Documentation.

Once your app is tested and ready, you can submit. But first, make sure that your app follows these guidelines:
- Uses the Astralixi API
- TUI only, no GUI mechanics
